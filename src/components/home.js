          ...
          <Grid item container xs={12}>
              ...
              <form className='signup-modal'>
                ...
                <Grid item xs={10} className='leftimg' style={{display:'flex',flexWrap: 'wrap', alignItems:'stretch'}}>
                  ...
                  <p style={{position:'absolute',color:'rgba(255, 255, 255, 0.65)', width: '105.6px', height: '18px', left:'666px', top:'435px',fontstyle: 'normal', fontWeight: '300', fontSize: '12px', lineHeight: '18px'}}>Forgot Password?</p></Grid>
